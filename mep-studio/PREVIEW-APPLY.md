...
## Sandbox phiên: `~/MEP-Studio/sessions/<id>/`
```
...
4. Tests: `pnpm --filter @mep/daemon test:live-preview`.
...
- ✅ Tests: `pnpm --filter @mep/daemon test:preview` (`scripts/test-preview-apply.mjs`)
