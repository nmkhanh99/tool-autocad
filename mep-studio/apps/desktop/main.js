...
const PORT = 8788;
const DEV_URL = process.env.MEP_WEB_URL || "http://localhost:3000";
...
function createWindow(url) {
  const win = new BrowserWindow({
    ...
    title: "MEP Studio", backgroundColor: "#0f1216",
